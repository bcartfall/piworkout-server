"""
Source: https://github.com/makerGeek/python-hotreload/blob/master/SourceChangeMonitor.py
"""
...
class SourceChangeMonitor(threading.Thread):
	...
	# Here, we deliberately exclude files beginning with a dot (.)
        ...
        def start_program(self):
                ...
                self._process = subprocess.Popen( [sys.executable, '-u', self.PROGRAM] )



if __name__ == "__main__":
        print('Monitoring files (.py) for changes.')
